...
(function() {
  this.rebuild_sortable_tree = function(rebuild_url, item_id, parent_id, prev_id, next_id) {
    return $.ajax({
      ...
      beforeSend: function(xhr) {
        return $('.sortable-tree i.handle').hide();
      },
      success: function(data, status, xhr) {
        return $('.sortable-tree i.handle').show();
      },
      error: function(xhr, status, error) {
  ...
  $(function() {
    ...
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      ...
      _results.push(sortable_tree.on("sortupdate", function(event, ui) {
...
(function() {
  $(function() {
    ...
    $('[data-tags][data-value]').each(function() {
      return $(this).select2('data', $(this).data('value'));
    });
    return $('#timeslot_artist_ids').select2({
      width: '76%'
    });
  });
